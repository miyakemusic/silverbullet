...
public class DependencyTreeUi extends AnchorPane {
	...
	private void buildUi() {
		...
		DependencyBuilder builder = new DependencyBuilder(property.getId(), dependencyEditorModel.getDependencySpecHolder());
		DependencyNode tree = builder.getTree();
		
		DependencySpec spec = dependencyEditorModel.getDependencySpecHolder().get(property.getId());
