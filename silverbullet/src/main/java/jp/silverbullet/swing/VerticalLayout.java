...
//$Header: /home/cvs/jakarta-jmeter/src/jorphan/org/apache/jorphan/gui/layout/VerticalLayout.java,v 1.4 2004/02/11 23:48:59 sebb Exp $
/*
...
public class VerticalLayout implements LayoutManager, Serializable
{
  ...
  * @param vgap       an int value indicating the vertical seperation of the
  *                   components
  * @param alignment  an int value which is one of RIGHT, LEFT,
  *                   CENTER, BOTH for the horizontal alignment.
  */
  ...
  *@param vgap       an int value indicating the vertical seperation of the
  *                  components
  *@param alignment  an int value which is one of RIGHT, LEFT, CENTER,
  *                  BOTH for the horizontal alignment.
  *@param anchor     an int value which is one of TOP, BOTTOM,
  *                  CENTER indicating where the components are to
